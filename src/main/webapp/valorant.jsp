...
<html>
    <head>
        <title>VALORANT - VOCA SHOP</title>
        ...
        <script type="text/javascript">
            ...
            function toggleSignin(){
              ...
              var types = document.getElementsByName('valotype');
               if(types[0].checked){
                  document.getElementById("pricez").innerHTML="Rp. 50.000,00";
                  document.getElementById("itemname").innerHTML="VALO 420";
               }else if(types[1].checked){
                  document.getElementById("pricez").innerHTML="Rp. 80.000,00";
                  document.getElementById("itemname").innerHTML="VALO 700";
    
               }else if(types[2].checked){
                  document.getElementById("pricez").innerHTML="Rp. 150.000,00";
                  document.getElementById("itemname").innerHTML="VALO 1375";
    
               }
               else if(types[3].checked){
                  document.getElementById("pricez").innerHTML="Rp. 250.000,00";
                  document.getElementById("itemname").innerHTML="VALO 2400";
    
               }
               else if(types[4].checked){
                  document.getElementById("pricez").innerHTML="Rp. 400.000,00";
                  document.getElementById("itemname").innerHTML="VALO 4000";
    
               }
               else if(types[5].checked){
                  document.getElementById("pricez").innerHTML="Rp. 800.000,00";
                  document.getElementById("itemname").innerHTML="VALO 8000";
   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/banner/valorantbg.jpg)">
      <div class="banner-text">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title">Valorant</h1>
                     <ol class="breadcrumb">
                        <li>Riot Point</li>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                     ...
                     <h3 class="service-box-title">420 Points</h3>
                     
                          
                     <p> <b>Game Information</b>
                         <li>Official Website : <a href="https://playvalorant.com/en-gb/">https://playvalorant.com/en-gb/</a></li>
                         <li>UI Language : English</li>
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 50.000,00</h3>
           ...
           <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                     ...
                     <h3 class="service-box-title">700 Points</h3>
                     ...
                     <p> <b>Game Information</b>
                         ...
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 80.000,00</h3>
                     </label>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                     ...
                     <h3 class="service-box-title">1375 Points</h3>
                     ...
                     <p> <b>Game Information</b>
                         ...
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 150.000,00</h3>
                        </label>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                     ...
                     <h3 class="service-box-title">2400 Points</h3>
                     ...
                     <p> <b>Game Information</b>
                         ...
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 250.000,00</h3>
                        </label>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <input type="radio" value="VALO5" class="hidebox" id="item5" name="valotype">
                        <label for="item5" class="radioitm">
                     <h3 class="service-box-title">4000 Points</h3>
                     ...
                     <p> <b>Game Information</b>
                         ...
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 400.000,00</h3>
                    </label>
            ...
            <div class="col-md-4">
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <input type="radio" value="VALO6" class="hidebox" id="item6" name="valotype">
                        <label for="item6" class="radioitm">
                     <h3 class="service-box-title">8150 Points</h3>
                     ...
                     <p> <b>Game Information</b>
                         ...
                         <li>Platform : PC</li>
                         <li>Publisher : Riot Games Inc.</li></p>
                     <h3 class="service-box-title">Rp. 800.000,00</h3>
                        </label>

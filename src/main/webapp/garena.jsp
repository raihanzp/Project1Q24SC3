...
<html>
        ...
        <script type="text/javascript">
            ...
            function toggleSignin(){
              ...
              var types = document.getElementsByName('valotype');
               if(types[0].checked){
                  document.getElementById("pricez").innerHTML="Rp. 10.000,00";
                  document.getElementById("itemname").innerHTML="GARENA 33";
               }else if(types[1].checked){
                  document.getElementById("pricez").innerHTML="Rp. 20.000,00";
                  document.getElementById("itemname").innerHTML="GARENA 66";
    
               }else if(types[2].checked){
                  document.getElementById("pricez").innerHTML="Rp. 50.000,00";
                  document.getElementById("itemname").innerHTML="GARENA 165";
    
               }
               else if(types[3].checked){
                  document.getElementById("pricez").innerHTML="Rp. 100.000,00";
                  document.getElementById("itemname").innerHTML="GARENA 330";
   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/banner/garenabg.jpg)">
      <div class="banner-text">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     <h1 class="banner-title">Garena</h1>
               ...
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <label for="item1" class="radioitm">
                            ...
                            <h3 class="service-box-title">33 Shells</h3>
                     
                     <p> <b>Game Information</b>
                         <li>Official Website : <a href="https://www.garena.co.id/">https://www.garena.co.id/</a></li>
                         <li>UI Language : English, Indonesian</li>
                         <li>Platform : PC</li>
                         <li>Publisher : Garena Inc.</li></p>
                     <h3 class="service-box-title">Rp. 10.000,00</h3>
               ...
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <label for="item2" class="radioitm">
                            <h3 class="service-box-title">66 Shells</h3>
                            ...
                            <p> <b>Game Information</b>
                                ...
                                <li>Platform : PC</li>
                                <li>Publisher : Garena Inc.</li></p>
                            <h3 class="service-box-title">Rp. 20.000,00</h3>
                     </label>
               ...
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <label for="item3" class="radioitm">
                            <h3 class="service-box-title">165 Shells</h3>
               ...
               <div class="ts-service-box">
                  <div class="ts-service-info">
                        ...
                        <label for="item4" class="radioitm">
                            <h3 class="service-box-title">330 Shells</h3>
                            ...
                            <p> <b>Game Information</b>
                                ...
                                <li>Platform : PC</li>
                                <li>Publisher : Garena Inc.</li></p>
                            <h3 class="service-box-title">Rp. 100.000,00</h3>
                        </label>

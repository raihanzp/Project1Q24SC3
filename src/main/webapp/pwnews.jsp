...
<head>
    ...
    <body>
		...
		<!-- Carousel -->
                <div id="banner-area" class="banner-area" style="background-image:url(images/banner/pw.jpg)">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
               ...
               <div class="post-content post-single">
                  <div class="post-media post-image image-angle">
                     <img src="images/news/pw1.jpg" class="img-responsive" alt=""/>
                  </div>
                  ...
                  <div class="post-body">
                     <div class="entry-header">
                        <div class="post-meta">
                           ...
                           <span class="post-meta-date"><i class="fa fa-calendar"></i> Oktober 22, 2020</span>
                           
                        </div>
                        <h2 class="entry-title">
                           <a href="pwnews.html">Siap Nostalgia di Dunia Fantasi Sesungguhnya? Perfect World Mobile Buka Tahap Pra-Registrasi!
</a>
                        </h2>
                     </div><!-- header end -->

                     <div class="entry-content">
                        <p>Perfect World adalah salah satu judul game yang cukup membuat para gamers nostalgia ke era tahun 2000-an awal. Dimana untuk era tersebut, banyak orang-orang yang rela berbondong-bondong ke Warung Internet (Warnet) untuk memainkan game MMORPG kesayangan mereka ini. Mengambil latar belakang tentang Dunia Fantasi yang memiliki 6 Faksi berbeda, membuat Perfect World terasa asik untuk dimainkan.</p>

                        <p>Jika kalian rindu dengan kehadiran game nostalgia satu ini, VNG membawa Perfect World ke Platform Mobile. Tak hanya itu, jika kalian melakukan Pra-Registrasi akan ada hadiah menanti. Hadiah tersebut adalah:</p>

                        <p>1. Skin : Charming Youth (7 Hari) </p>

                        
                        <p>2. Mirage Stone x5</p>

                       

                        <p>3. Overhaul Gem x5</p>
                        <p>Ketiga jenis item ini tentunya akan membantu kalian para PW Heroes untuk memulai petualangan di dunia Perfect World. Memiliki tagline “Fly With Me”, Perfect World Mobile juga menjanjikan petualangan yang sama dengan Perfect World terdahulu di Platform PC. Sambil menunggu game yang direncanakan rilis tanggal 5 November 2020 ini.</p>

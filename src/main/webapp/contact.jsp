    ...
    <body>
		...
		<!-- Carousel -->
                <div id="banner-area" class="banner-area" style="background-image: url(&quot;images/banner/banner3.jpg&quot;);">
                                    ...
                                    <p>Jalan Duren Bangka, No. 35 12760</p>
                                                     </div>
                                                   </div>
                                                </div><!-- Col 1 end -->

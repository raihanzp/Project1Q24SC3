...
<head>
    ...
    <body>
		...
		<!-- Carousel -->
                <div id="banner-area" class="banner-area" style="background-image:url(images/banner/gi.jpg)">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
               ...
               <div class="post-content post-single">
                  <div class="post-media post-image image-angle">
                     <img src="images/news/ge1.jpg" class="img-responsive" alt=""/>
                  </div>
                  ...
                  <div class="post-body">
                     <div class="entry-header">
                        <div class="post-meta">
                           ...
                           <span class="post-meta-date"><i class="fa fa-calendar"></i> Oktober 20, 2020</span>
                           
                        </div>
                        <h2 class="entry-title">
                           <a href="genews.html">Capek Ampas Mulu? Butuh Terapi? Seorang Gamer Ciptakan Simulasi Gacha Genshin Impact!
</a>
                        </h2>
                     </div><!-- header end -->

                     <div class="entry-content">
                        <p>Salah satu hal yang membuat kamu deg-degan ketika bermain Genshin Impact adalah soalnya Gacha-nya. Untuk mendapatkan karakter tertentu ataupun senjata terbaik hingga *5 biasanya kamu harus melakukan permohonan dan menggelontorkan sejumlah primogems untuk bisa memanggil Karakter yang kamu inginkan, meskipun pada kenyataannya banyak dari kalian yang mendapatkan pedang.</p>

                        <p>Karena Primogems cukup sulit untuk di dapatkan dan kamu hanya mendapatkan senjata hingga 10 set, membuatmu kesal dan ingin mencobanya lagi. Namun tidak semudah itu, karena kamu harus mencari Primogems lagi untuk bisa melakukannya. Menariknya, seorang gamer telah membuat situs simulasi gacha Genshin Impact untuk kamu yang sering kali gagal dalam gacha.</p>

                        <p>Dalam situs tersebut, terdapat simulasi berbagai banner Gacha yang sekarang sedang berlangsung di Genshin Impact. Mulai dari banner Klee, Senjata, hingga Banner Diluc, dan semuanya mengikuti mekanisme yang ada di Genshin Impact. Jika kamu terlalu kurang beruntung, kamu bisa mendapatkan Pity Guarantee di 90 tarikan ketika kamu tidak mendapatkan *5 sama sekali.</p>

                        
                        <p>Genshin Impact adalah game free-to-play action RPG dunia terbuka yang dikembangkan oleh miHoYo. Genshin Impact juga merupakan IP kedua yang dibesut oleh miHoYo setelah Honkai Impact 3. Game ini diperkirakan akan dirilis pada tanggal 28 September 2020 di platform Android, iOS, Windows, serta menyusul pada tahun 2020 di PlayStation 4.</p>
